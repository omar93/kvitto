...
function instructions(categories) {
  return [
    ...
    '- An INDENTED line under an item modifies that item; use the TOTAL amount printed',
    '  on it (the rightmost number) and let its SIGN decide:',
    '  * NEGATIVE (e.g. "Rabatt:... -5,00", "Willys Plus:... -22,77") -> a discount: add',
    '    its absolute value to that item\'s "discount", and append " -R" to the name.',
    '  * POSITIVE "+PANT" line (e.g. "+PANT ... 3st*2,00  6,00") -> pant: add that total',
    '    (6.00) to that item\'s "deposit".',
    '  Pant is NOT a discount. Never copy the price into deposit or discount, and never',
    '  invent a discount that is not printed. If there is no modifier line, use 0.',
    ...
    '  with pant:   { "name": "Cola Sockerfri 2L", "price": 13.15, "discount": 0, "quantity": 3, "deposit": 6.00, "category": "Läsk/Snäx" }',
